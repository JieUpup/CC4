...
class NashEquilibriumAgent:
    def __init__(self, name, observation_space, action_space_size, lr=1e-3, gamma=0.99, epsilon=1.0, epsilon_decay=0.995, min_epsilon=0.01, batch_size=64, memory_size=10000):
...
def train_agent():
    ...
    agent = NashEquilibriumAgent("Agent1", observation_space, action_space_size)
    ...
    csv_path = os.path.join(results_dir, "training_rewards.csv")
    ...
    model_path = os.path.join(results_dir, "nash_equilibrium_agent_model.pth")
